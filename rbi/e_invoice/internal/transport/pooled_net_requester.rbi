      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                EInvoice::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: EInvoice::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: EInvoice::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
