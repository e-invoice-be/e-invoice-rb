  ...
  module Models
    class LookupRetrieveResponse < EInvoice::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            EInvoice::Models::LookupRetrieveResponse,
            EInvoice::Internal::AnyHash
          )
        end

      # Business card information for the Peppol participant
      sig { returns(EInvoice::Models::LookupRetrieveResponse::BusinessCard) }
      attr_reader :business_card

      sig do
        params(
          business_card:
            EInvoice::Models::LookupRetrieveResponse::BusinessCard::OrHash
        ).void
      end
      attr_writer :business_card

      # List of certificates found for the Peppol participant
      sig { returns(T::Array[EInvoice::Certificate]) }
      attr_accessor :certificates

      # Information about the DNS lookup performed
      sig { returns(EInvoice::Models::LookupRetrieveResponse::DNSInfo) }
      attr_reader :dns_info

      sig do
        params(
          dns_info: EInvoice::Models::LookupRetrieveResponse::DNSInfo::OrHash
        ).void
      end
      ...
      sig { returns(EInvoice::Models::LookupRetrieveResponse::QueryMetadata) }
      attr_reader :query_metadata

      sig do
        params(
          query_metadata:
            EInvoice::Models::LookupRetrieveResponse::QueryMetadata::OrHash
        ).void
      end
      attr_writer :query_metadata

      # Service metadata information for the Peppol participant
      sig { returns(EInvoice::Models::LookupRetrieveResponse::ServiceMetadata) }
      attr_reader :service_metadata

      sig do
        params(
          service_metadata:
            EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::OrHash
        ).void
      end
      ...
      sig do
        params(
          business_card:
            EInvoice::Models::LookupRetrieveResponse::BusinessCard::OrHash,
          certificates: T::Array[EInvoice::Certificate::OrHash],
          dns_info: EInvoice::Models::LookupRetrieveResponse::DNSInfo::OrHash,
        ...
        override.returns(
          {
            ...
            certificates: T::Array[EInvoice::Certificate],
      ...
      class BusinessCard < EInvoice::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              EInvoice::Models::LookupRetrieveResponse::BusinessCard::Entity
            ]
          )
        end
        ...
        sig do
          params(
            entities:
              T::Array[
                EInvoice::Models::LookupRetrieveResponse::BusinessCard::Entity::OrHash
              ],
            query_time_ms: Float,
            status: String,
      ...
      class DNSInfo < EInvoice::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              EInvoice::Models::LookupRetrieveResponse::DNSInfo,
              EInvoice::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              EInvoice::Models::LookupRetrieveResponse::DNSInfo::DNSRecord
            ]
          )
        end
        ...
        sig do
          params(
            dns_records:
              T::Array[
                EInvoice::Models::LookupRetrieveResponse::DNSInfo::DNSRecord::OrHash
              ],
            sml_hostname: String,
            status: String,
            error: T.nilable(String)
      ...
      class ServiceMetadata < EInvoice::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint
            ]
          )
        end
        ...
        sig do
          params(
            endpoints:
              T::Array[
                EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::OrHash
              ],
            query_time_ms: Float,
            status: String,
            error: T.nilable(String)
        ...
        class Endpoint < EInvoice::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::DocumentType
              ]
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process
                ]
              )
            )
          end
          ...
          sig do
            params(
              document_types:
                T::Array[
                  EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::DocumentType::OrHash
                ],
              status: String,
              url: String,
              error: T.nilable(String),
              processes:
                T.nilable(
                  T::Array[
                    EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
          ...
          class Process < EInvoice::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::Endpoint
                ]
              )
            end
            attr_accessor :endpoints
            ...
            sig do
              params(
                process_id:
                  EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::ProcessID::OrHash
              ).void
            end
            ...
            sig do
              params(
                endpoints:
                  T::Array[
                    EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::Endpoint::OrHash
                  ],
                process_id:
                  EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::ProcessID::OrHash
              ).returns(T.attached_class)
            ...
            class Endpoint < EInvoice::Internal::Type::BaseModel
              ...
              sig { returns(T.nilable(EInvoice::Certificate)) }
              attr_reader :certificate

              sig do
                params(
                  certificate: T.nilable(EInvoice::Certificate::OrHash)
                ).void
              end
                ...
                override.returns(
                  {
                    address: String,
                    transport_profile: String,
                    certificate: T.nilable(EInvoice::Certificate),
                    service_activation_date: T.nilable(String),
                    service_description: T.nilable(String),
                    service_expiration_date: T.nilable(String),
                    technical_contact_url: T.nilable(String),
