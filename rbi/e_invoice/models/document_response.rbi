...
module EInvoice
  module Models
    class DocumentResponse < EInvoice::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(EInvoice::DocumentResponse, EInvoice::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(T::Array[EInvoice::Documents::DocumentAttachment]))
      end
      attr_reader :attachments

      sig do
        params(
          attachments: T::Array[EInvoice::Documents::DocumentAttachment::OrHash]
        ).void
      end
      ...
      sig { returns(T.nilable(EInvoice::CurrencyCode::TaggedSymbol)) }
      ...
      sig { returns(T.nilable(EInvoice::DocumentDirection::TaggedSymbol)) }
      attr_reader :direction

      sig { params(direction: EInvoice::DocumentDirection::OrSymbol).void }
      attr_writer :direction

      sig { returns(T.nilable(EInvoice::DocumentType::TaggedSymbol)) }
      ...
      sig { returns(T.nilable(T::Array[EInvoice::DocumentResponse::Item])) }
      attr_reader :items

      sig do
        params(items: T::Array[EInvoice::DocumentResponse::Item::OrHash]).void
      end
      attr_writer :items
      ...
      sig do
        returns(T.nilable(T::Array[EInvoice::DocumentResponse::PaymentDetail]))
      end
      ...
      sig do
        params(
          payment_details:
            T::Array[EInvoice::DocumentResponse::PaymentDetail::OrHash]
        ).void
      end
      ...
      sig { returns(T.nilable(EInvoice::DocumentState::TaggedSymbol)) }
      attr_reader :state
      ...
      sig do
        returns(T.nilable(T::Array[EInvoice::DocumentResponse::TaxDetail]))
      end
      attr_reader :tax_details

      sig do
        params(
          tax_details: T::Array[EInvoice::DocumentResponse::TaxDetail::OrHash]
        ).void
      end
      ...
      sig do
        params(
          ...
          attachments:
            T::Array[EInvoice::Documents::DocumentAttachment::OrHash],
          ...
          items: T::Array[EInvoice::DocumentResponse::Item::OrHash],
        ...
        override.returns(
          {
            id: String,
            amount_due: T.nilable(String),
            attachments: T::Array[EInvoice::Documents::DocumentAttachment],
            billing_address: T.nilable(String),
            billing_address_recipient: T.nilable(String),
            currency: EInvoice::CurrencyCode::TaggedSymbol,
            customer_address: T.nilable(String),
            customer_address_recipient: T.nilable(String),
            customer_email: T.nilable(String),
            customer_id: T.nilable(String),
            customer_name: T.nilable(String),
            customer_tax_id: T.nilable(String),
            direction: EInvoice::DocumentDirection::TaggedSymbol,
            document_type: EInvoice::DocumentType::TaggedSymbol,
            due_date: T.nilable(Date),
            invoice_date: T.nilable(Date),
            invoice_id: T.nilable(String),
            invoice_total: T.nilable(String),
            items: T::Array[EInvoice::DocumentResponse::Item],
            note: T.nilable(String),
            payment_details:
              T::Array[EInvoice::DocumentResponse::PaymentDetail],
            payment_term: T.nilable(String),
            previous_unpaid_balance: T.nilable(String),
            purchase_order: T.nilable(String),
            remittance_address: T.nilable(String),
            ...
            shipping_address: T.nilable(String),
            shipping_address_recipient: T.nilable(String),
            state: EInvoice::DocumentState::TaggedSymbol,
            subtotal: T.nilable(String),
            tax_details: T::Array[EInvoice::DocumentResponse::TaxDetail],
            total_discount: T.nilable(String),
            total_tax: T.nilable(String),
            vendor_address: T.nilable(String),
            vendor_address_recipient: T.nilable(String),
      ...
      class Item < EInvoice::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(EInvoice::DocumentResponse::Item, EInvoice::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(EInvoice::UnitOfMeasureCode::TaggedSymbol)) }
        attr_accessor :unit
          ...
          override.returns(
            {
              ...
              tax: T.nilable(String),
              tax_rate: T.nilable(String),
              unit: T.nilable(EInvoice::UnitOfMeasureCode::TaggedSymbol),
              unit_price: T.nilable(String)
            }
          )
        end
      ...
      class PaymentDetail < EInvoice::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              EInvoice::DocumentResponse::PaymentDetail,
      ...
      class TaxDetail < EInvoice::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              EInvoice::DocumentResponse::TaxDetail,
              EInvoice::Internal::AnyHash
            )
          end
