...
module EInvoice
  module Models
    # @see EInvoice::Resources::Lookup#retrieve
    class LookupRetrieveResponse < EInvoice::Internal::Type::BaseModel
      ...
      #
      #   @return [EInvoice::Models::LookupRetrieveResponse::BusinessCard]
      required :business_card,
               -> { EInvoice::Models::LookupRetrieveResponse::BusinessCard },
               api_name: :businessCard

      # @!attribute certificates
      #   List of certificates found for the Peppol participant
      #
      #   @return [Array<EInvoice::Models::Certificate>]
      required :certificates, -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Certificate] }

      # @!attribute dns_info
      #   Information about the DNS lookup performed
      #
      #   @return [EInvoice::Models::LookupRetrieveResponse::DNSInfo]
      required :dns_info, -> { EInvoice::Models::LookupRetrieveResponse::DNSInfo }, api_name: :dnsInfo

      # @!attribute errors
      #   List of error messages if any errors occurred during the lookup
      #
      #   @return [Array<String>]
      required :errors, EInvoice::Internal::Type::ArrayOf[String]
      ...
      #
      #   @return [EInvoice::Models::LookupRetrieveResponse::QueryMetadata]
      required :query_metadata,
               -> { EInvoice::Models::LookupRetrieveResponse::QueryMetadata },
               api_name: :queryMetadata

      # @!attribute service_metadata
      #   Service metadata information for the Peppol participant
      #
      #   @return [EInvoice::Models::LookupRetrieveResponse::ServiceMetadata]
      required :service_metadata,
               -> { EInvoice::Models::LookupRetrieveResponse::ServiceMetadata },
      ...
      #
      #   @param business_card [EInvoice::Models::LookupRetrieveResponse::BusinessCard] Business card information for the Peppol participant
      #
      #   @param certificates [Array<EInvoice::Models::Certificate>] List of certificates found for the Peppol participant
      #
      #   @param dns_info [EInvoice::Models::LookupRetrieveResponse::DNSInfo] Information about the DNS lookup performed
      #
      ...
      #
      #   @param query_metadata [EInvoice::Models::LookupRetrieveResponse::QueryMetadata] Metadata about the query that was performed
      #
      #   @param service_metadata [EInvoice::Models::LookupRetrieveResponse::ServiceMetadata] Service metadata information for the Peppol participant
      #
      #   @param status [String] Overall status of the lookup: 'success' or 'error'

      # @see EInvoice::Models::LookupRetrieveResponse#business_card
      class BusinessCard < EInvoice::Internal::Type::BaseModel
        # @!attribute entities
        #   List of business entities associated with the Peppol ID
        #
        #   @return [Array<EInvoice::Models::LookupRetrieveResponse::BusinessCard::Entity>]
        required :entities,
                 -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Models::LookupRetrieveResponse::BusinessCard::Entity] }
        ...
        #   Business card information for the Peppol participant
        #
        #   @param entities [Array<EInvoice::Models::LookupRetrieveResponse::BusinessCard::Entity>] List of business entities associated with the Peppol ID
        #
        ...
        class Entity < EInvoice::Internal::Type::BaseModel
          ...
          optional :additional_information,
                   EInvoice::Internal::Type::ArrayOf[String],
      ...
      # @see EInvoice::Models::LookupRetrieveResponse#dns_info
      class DNSInfo < EInvoice::Internal::Type::BaseModel
        # @!attribute dns_records
        #   List of DNS records found for the Peppol participant
        #
        #   @return [Array<EInvoice::Models::LookupRetrieveResponse::DNSInfo::DNSRecord>]
        required :dns_records,
                 -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Models::LookupRetrieveResponse::DNSInfo::DNSRecord] },
                 api_name: :dnsRecords
        ...
        #   Information about the DNS lookup performed
        #
        #   @param dns_records [Array<EInvoice::Models::LookupRetrieveResponse::DNSInfo::DNSRecord>] List of DNS records found for the Peppol participant
        #
      ...
      # @see EInvoice::Models::LookupRetrieveResponse#query_metadata
      ...
      # @see EInvoice::Models::LookupRetrieveResponse#service_metadata
      class ServiceMetadata < EInvoice::Internal::Type::BaseModel
        # @!attribute endpoints
        #   List of endpoints found for the Peppol participant
        #
        #   @return [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint>]
        required :endpoints,
                 -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint] }
        ...
        #   Service metadata information for the Peppol participant
        #
        #   @param endpoints [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint>] List of endpoints found for the Peppol participant
        #
        ...
        class Endpoint < EInvoice::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::DocumentType>]
          required :document_types,
                   -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::DocumentType] },
          ...
          #
          #   @return [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process>, nil]
          optional :processes,
                   -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process] },
                   nil?: true

          # @!method initialize(document_types:, status:, url:, error: nil, processes: nil)
          #   Information about a Peppol participant's endpoint.
          #
          #   @param document_types [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::DocumentType>] List of document types supported by this endpoint
          #
          ...
          #
          #   @param processes [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process>, nil] List of processes supported by this endpoint
          ...
          class Process < EInvoice::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::Endpoint>]
            required :endpoints,
                     -> { EInvoice::Internal::Type::ArrayOf[EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::Endpoint] }

            # @!attribute process_id
            #   Identifier of the process
            #
            #   @return [EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::ProcessID]
            required :process_id,
                     -> { EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::ProcessID },
                     api_name: :processId

            # @!method initialize(endpoints:, process_id:)
            #   Process information in the Peppol network.
            #
            #   @param endpoints [Array<EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::Endpoint>] List of endpoints supporting this process
            #
            #   @param process_id [EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process::ProcessID] Identifier of the process
            ...
            class Endpoint < EInvoice::Internal::Type::BaseModel
              ...
              #
              #   @return [EInvoice::Models::Certificate, nil]
              optional :certificate, -> { EInvoice::Certificate }, nil?: true
              ...
              #
              #   @param certificate [EInvoice::Models::Certificate, nil] Certificate information for a Peppol endpoint.
              #
            ...
            # @see EInvoice::Models::LookupRetrieveResponse::ServiceMetadata::Endpoint::Process#process_id
