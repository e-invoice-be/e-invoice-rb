...
module EInvoice
  module Models
    class DocumentCreate < EInvoice::Internal::Type::BaseModel
      ...
      optional :amount_due, union: -> { EInvoice::DocumentCreate::AmountDue }, nil?: true

      # @!attribute attachments
      #
      #   @return [Array<EInvoice::Models::DocumentAttachmentCreate>, nil]
      optional :attachments,
               -> { EInvoice::Internal::Type::ArrayOf[EInvoice::DocumentAttachmentCreate] },
               nil?: true
      ...
      #
      #   @return [Float, String, nil]
      optional :invoice_total, union: -> { EInvoice::DocumentCreate::InvoiceTotal }, nil?: true

      # @!attribute items
      #
      #   @return [Array<EInvoice::Models::DocumentCreate::Item>, nil]
      optional :items, -> { EInvoice::Internal::Type::ArrayOf[EInvoice::DocumentCreate::Item] }, nil?: true
      ...
      #
      #   @return [Array<EInvoice::Models::PaymentDetailCreate>, nil]
      optional :payment_details,
               -> { EInvoice::Internal::Type::ArrayOf[EInvoice::PaymentDetailCreate] },
               nil?: true
      ...
      optional :previous_unpaid_balance,
               union: -> { EInvoice::DocumentCreate::PreviousUnpaidBalance },
               nil?: true
      ...
      #
      #   @return [Float, String, nil]
      optional :subtotal, union: -> { EInvoice::DocumentCreate::Subtotal }, nil?: true

      # @!attribute tax_details
      #
      #   @return [Array<EInvoice::Models::DocumentCreate::TaxDetail>, nil]
      optional :tax_details,
               -> { EInvoice::Internal::Type::ArrayOf[EInvoice::DocumentCreate::TaxDetail] },
               nil?: true

      # @!attribute total_discount
      #
      #   @return [Float, String, nil]
      optional :total_discount, union: -> { EInvoice::DocumentCreate::TotalDiscount }, nil?: true

      # @!attribute total_tax
      #
      #   @return [Float, String, nil]
      optional :total_tax, union: -> { EInvoice::DocumentCreate::TotalTax }, nil?: true
      ...
      # @see EInvoice::Models::DocumentCreate#amount_due
      module AmountDue
      ...
      # @see EInvoice::Models::DocumentCreate#invoice_total
      module InvoiceTotal
        extend EInvoice::Internal::Type::Union
      ...
      class Item < EInvoice::Internal::Type::BaseModel
        ...
        #
        #   @return [Float, String, nil]
        optional :amount, union: -> { EInvoice::DocumentCreate::Item::Amount }, nil?: true
        ...
        #
        #   @return [Float, String, nil]
        optional :quantity, union: -> { EInvoice::DocumentCreate::Item::Quantity }, nil?: true

        # @!attribute tax
        #
        #   @return [Float, String, nil]
        optional :tax, union: -> { EInvoice::DocumentCreate::Item::Tax }, nil?: true
        ...
        #
        #   @return [Float, String, nil]
        optional :unit_price, union: -> { EInvoice::DocumentCreate::Item::UnitPrice }, nil?: true
        ...
        # @see EInvoice::Models::DocumentCreate::Item#amount
        module Amount
          extend EInvoice::Internal::Type::Union
        ...
        # @see EInvoice::Models::DocumentCreate::Item#quantity
        module Quantity
          extend EInvoice::Internal::Type::Union
        ...
        # @see EInvoice::Models::DocumentCreate::Item#tax
        module Tax
          extend EInvoice::Internal::Type::Union
        ...
        # @see EInvoice::Models::DocumentCreate::Item#unit_price
        module UnitPrice
          extend EInvoice::Internal::Type::Union
      ...
      # @see EInvoice::Models::DocumentCreate#previous_unpaid_balance
      ...
      # @see EInvoice::Models::DocumentCreate#subtotal
      module Subtotal
        extend EInvoice::Internal::Type::Union
      ...
      class TaxDetail < EInvoice::Internal::Type::BaseModel
        ...
        #
        #   @return [Float, String, nil]
        optional :amount, union: -> { EInvoice::DocumentCreate::TaxDetail::Amount }, nil?: true
        ...
        # @see EInvoice::Models::DocumentCreate::TaxDetail#amount
        module Amount
          extend EInvoice::Internal::Type::Union
      ...
      # @see EInvoice::Models::DocumentCreate#total_discount
      ...
      # @see EInvoice::Models::DocumentCreate#total_tax
      module TotalTax
        extend EInvoice::Internal::Type::Union
