  ...
  module Internal
    ...
    class DocumentsNumberPage
      ...
      def next_page
        ...
        req = EInvoice::Internal::Util.deep_merge(@req, {query: {page: (page || 1).to_i.succ}})
        @client.request(req)
      end
      ...
      # @api private
      #
      # @param client [EInvoice::Internal::Transport::BaseClient]
      ...
      def initialize(client:, req:, headers:, page_data:)
        ...
        in {items: Array => items}
          @items = items.map { EInvoice::Internal::Type::Converter.coerce(@model, _1) }
        else
        end
        @page = page_data[:page]
      ...
      def inspect
        ...
        model = EInvoice::Internal::Type::Converter.inspect(@model, depth: 1)
