    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { EInvoice::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { EInvoice::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in EInvoice::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [EInvoice::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          def coerce(
            ...
            case target
            in EInvoice::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in EInvoice::Internal::Type::Converter
              ...
              EInvoice::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(EInvoice::Internal::Type::Converter, T::Class[T.anything]) }
        end
