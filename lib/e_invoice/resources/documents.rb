...
module EInvoice
  module Resources
    class Documents
      # @return [EInvoice::Resources::Documents::Attachments]
      attr_reader :attachments

      # @return [EInvoice::Resources::Documents::Ubl]
      attr_reader :ubl
      ...
      #
      # @return [EInvoice::Models::DocumentResponse]
      #
      # @see EInvoice::Models::DocumentCreateParams
      def create(params = {})
        parsed, options = EInvoice::DocumentCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: "api/documents/",
          body: parsed,
      ...
      # @return [EInvoice::Models::DocumentResponse]
      #
      # @see EInvoice::Models::DocumentRetrieveParams
      ...
      # @param request_options [EInvoice::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [EInvoice::Models::DocumentDeleteResponse]
      #
      # @see EInvoice::Models::DocumentDeleteParams
      def delete(document_id, params = {})
        @client.request(
          method: :delete,
          path: ["api/documents/%1$s", document_id],
          model: EInvoice::Models::DocumentDeleteResponse,
          options: params[:request_options]
        )
      end
      ...
      # @return [EInvoice::Models::DocumentResponse]
      #
      # @see EInvoice::Models::DocumentSendParams
      def send_(document_id, params = {})
        parsed, options = EInvoice::DocumentSendParams.dump_request(params)
        @client.request(
          method: :post,
      ...
      def initialize(client:)
        @client = client
        @attachments = EInvoice::Resources::Documents::Attachments.new(client: client)
        @ubl = EInvoice::Resources::Documents::Ubl.new(client: client)
      end
    end
  end
end
