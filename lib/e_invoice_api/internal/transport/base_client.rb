  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => EInvoiceAPI::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => EInvoiceAPI::Internal::Util.os,
            "x-stainless-package-version" => EInvoiceAPI::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = EInvoiceAPI::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise EInvoiceAPI::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if EInvoiceAPI::Internal::Util.uri_origin(url) != EInvoiceAPI::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, EInvoiceAPI::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in EInvoiceAPI::Errors::APIConnectionError | (500..)
        ...
        # @api private
        # @return [EInvoiceAPI::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = EInvoiceAPI::Internal::Transport::PooledNetRequester.new
          @headers = EInvoiceAPI::Internal::Util.normalized_headers(
          ...
          @base_url_components = EInvoiceAPI::Internal::Util.parse_uri(base_url)
          @base_url = EInvoiceAPI::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<EInvoiceAPI::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<EInvoiceAPI::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [EInvoiceAPI::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = EInvoiceAPI::Internal::Util.interpolate_path(uninterpolated_path)

          query = EInvoiceAPI::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = EInvoiceAPI::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise EInvoiceAPI::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
            decoded = Kernel.then do
              EInvoiceAPI::Internal::Util.decode_content(response, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end
          ...
          in (400..) | EInvoiceAPI::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: EInvoiceAPI::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<EInvoiceAPI::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<EInvoiceAPI::Internal::Type::BaseStream>, nil]
        #
        # @param model [EInvoiceAPI::Internal::Type::Converter, Class, nil]
        #
        # @param options [EInvoiceAPI::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[EInvoiceAPI::Internal::Type::BasePage[EInvoiceAPI::Internal::Type::BaseModel]]),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(EInvoiceAPI::Internal::Type::Converter::Input),
              options: T.nilable(EInvoiceAPI::RequestOptions::OrHash)
            }
          end
        end
