...
class EInvoice::Test::SingletonClient < EInvoice::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: EInvoice::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class EInvoice::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @e_invoice = EInvoice::Test::SingletonClient.instance
  end
