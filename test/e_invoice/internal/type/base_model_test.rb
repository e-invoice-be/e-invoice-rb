...
class EInvoice::Test::PrimitiveModelTest < Minitest::Test
  A = EInvoice::Internal::Type::ArrayOf[-> { Integer }]
  H = EInvoice::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < EInvoice::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      EInvoice::Internal::Type::Unknown,
      EInvoice::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => EInvoice::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [EInvoice::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [EInvoice::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [EInvoice::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        EInvoice::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [EInvoice::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [EInvoice::Internal::Type::Boolean, true] => true,
      [EInvoice::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => EInvoice::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        EInvoice::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do
      ...
      assert_raises(_2) do
        EInvoice::Internal::Type::Converter.coerce(target, input, state: state)
      end
    end
  end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        EInvoice::Internal::Type::Converter.dump(target, input, state: state)
...
class EInvoice::Test::EnumModelTest < Minitest::Test
  class E0
    include EInvoice::Internal::Type::Enum
    attr_reader :values
...
class EInvoice::Test::CollectionModelTest < Minitest::Test
  A1 = EInvoice::Internal::Type::ArrayOf[-> { Integer }]
  H1 = EInvoice::Internal::Type::HashOf[Integer]

  A2 = EInvoice::Internal::Type::ArrayOf[H1]
  H2 = EInvoice::Internal::Type::HashOf[-> { A1 }]

  A3 = EInvoice::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = EInvoice::Internal::Type::HashOf[Integer, nil?: true]
...
class EInvoice::Test::BaseModelTest < Minitest::Test
  class M1 < EInvoice::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < EInvoice::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < EInvoice::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, EInvoice::Internal::Type::ArrayOf[M6]
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = {strictness: true, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
      assert_pattern do
        coerced = EInvoice::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(EInvoice::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      _2.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue EInvoice::Errors::ConversionError => e
...
class EInvoice::Test::UnionTest < Minitest::Test
  class U0
    include EInvoice::Internal::Type::Union
  ...
  class M2 < EInvoice::Internal::Type::BaseModel
  ...
  class M4 < EInvoice::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, EInvoice::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < EInvoice::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, EInvoice::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class EInvoice::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include EInvoice::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [EInvoice::Internal::Type::Unknown, EInvoice::Internal::Type::Unknown] => true,
      [EInvoice::Internal::Type::Boolean, EInvoice::Internal::Type::Boolean] => true,
      [EInvoice::Internal::Type::Unknown, EInvoice::Internal::Type::Boolean] => false,
