...
class EInvoiceAPI::Test::PrimitiveModelTest < Minitest::Test
  A = EInvoiceAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = EInvoiceAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < EInvoiceAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      EInvoiceAPI::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => EInvoiceAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [EInvoiceAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [EInvoiceAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [EInvoiceAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        EInvoiceAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [EInvoiceAPI::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [EInvoiceAPI::Internal::Type::Boolean, true] => true,
      [EInvoiceAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => EInvoiceAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        EInvoiceAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = EInvoiceAPI::Internal::Type::Converter.new_coerce_state
      EInvoiceAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        EInvoiceAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class EInvoiceAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include EInvoiceAPI::Internal::Type::Enum
    attr_reader :values
...
class EInvoiceAPI::Test::CollectionModelTest < Minitest::Test
  A1 = EInvoiceAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = EInvoiceAPI::Internal::Type::HashOf[Integer]

  A2 = EInvoiceAPI::Internal::Type::ArrayOf[H1]
  H2 = EInvoiceAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = EInvoiceAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = EInvoiceAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class EInvoiceAPI::Test::BaseModelTest < Minitest::Test
  class M1 < EInvoiceAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < EInvoiceAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < EInvoiceAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, EInvoiceAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = EInvoiceAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = EInvoiceAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(EInvoiceAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue EInvoiceAPI::Errors::ConversionError => e
...
class EInvoiceAPI::Test::UnionTest < Minitest::Test
  class U0
    include EInvoiceAPI::Internal::Type::Union
  ...
  class M2 < EInvoiceAPI::Internal::Type::BaseModel
  ...
  class M4 < EInvoiceAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, EInvoiceAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < EInvoiceAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, EInvoiceAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class EInvoiceAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include EInvoiceAPI::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [EInvoiceAPI::Internal::Type::Unknown, EInvoiceAPI::Internal::Type::Unknown] => true,
      [EInvoiceAPI::Internal::Type::Boolean, EInvoiceAPI::Internal::Type::Boolean] => true,
      [EInvoiceAPI::Internal::Type::Unknown, EInvoiceAPI::Internal::Type::Boolean] => false,
...
class EInvoiceAPI::Test::MetaInfoTest < Minitest::Test
  A1 = EInvoiceAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = EInvoiceAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
