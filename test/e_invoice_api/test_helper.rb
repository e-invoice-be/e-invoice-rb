...
class EInvoiceAPI::Test::SingletonClient < EInvoiceAPI::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: EInvoiceAPI::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class EInvoiceAPI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @e_invoice = EInvoiceAPI::Test::SingletonClient.instance
  end
